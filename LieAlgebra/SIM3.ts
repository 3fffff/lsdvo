...
export class SIM3 {
  ...
  public static ln(sim3: SIM3): Float32Array {
    ...
    let W: Float32Array = Vec.matrixAdd(Vec.matrixAdd((Vec.matrixMul(Vec.matrixEye(3), coeff[0])), (Vec.matrixMul(cross, coeff[1]))), (Vec.matrixMul(Vec.multiplicar(cross, cross, 3, 3, 3, 3), coeff[2])));
