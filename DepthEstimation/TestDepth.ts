...
export class TestDepth {
  ...
  constructor(map: DepthMap) {
    this.width = this.stereoTest.width = this.stereoTest.width = this.keyFrame.width = this.grad.width = map.width;
    this.height = this.stereoTest.height = this.stereoTestReference.height = this.keyFrame.height = this.grad.height = map.height;
